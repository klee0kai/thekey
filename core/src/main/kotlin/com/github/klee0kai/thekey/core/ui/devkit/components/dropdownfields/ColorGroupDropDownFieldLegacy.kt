...
@Composable
@Deprecated("use ColorGroupDropDownField")
fun ColorGroupDropDownFieldLegacy(
...
@Composable
@Preview
fun ColorGroupDropDownFieldLegacyPreview() = AppTheme(theme = DefaultThemes.darkTheme) {
    ColorGroupDropDownFieldLegacy(
    )
}
